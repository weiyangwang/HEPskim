...
config.General.workArea = 'crabskim255031/MB'
...
#config.Data.outLFNDirBase = '/eos/user/q/qileong/data/255031/ZB2'
...
config.Data.inputDataset = '/L1MinimumBiasHF1/Run2015C_25ns-16Dec2015-v1/AOD'
